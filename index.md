...
&ensp;&ensp;&ensp;&ensp;通用微博训练数据集包括29,768条微博，测试数据集包含5,000条微博。

&ensp;&ensp;&ensp;&ensp;疫情微博训练数据集包括6,606条微博，测试数据集包含5,000条微博。

&ensp;&ensp;&ensp;&ensp;注意：测试数据集的各个类别分布与训练集相同。实际发布的测试集中会包含混淆数据，混淆数据不作为测点，在最终结果评测时会预先去除。
