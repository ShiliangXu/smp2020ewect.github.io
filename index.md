...
本届中文人机对话技术评测由中国中文信息学会社会媒体处理专委会主办，哈尔滨工业大学承办并提供数据集，上海蜜度信息技术有限公司提供奖金，旨在促进社交媒体情感分析相关研究的发展，为本领域的学术研究人员和产业界从业人员提供一个良好的沟通平台。
...
本次技术评测使用的数据集由哈尔滨工业大学社会计算与信息检索研究中心（哈工大SCIR）提供，数据来源于新浪微博，分为两部分。

第一部分是通用微博数据集，该数据集内的微博内容是随机获取到微博内容，不针对特定的话题，覆盖的范围较广。

第二部分是疫情微博数据集，该数据集内的微博内容是在疫情期间使用相关关键字筛选获得的疫情微博，其内容与新冠疫情相关。
...
通用微博训练数据集包括29769条微博，测试数据集规模在十万左右。

疫情微博训练数据集包括6607条微博，测试数据集规模在十万左右。

两个测试集中均包含混淆数据，混淆数据不作为测点，在最终结果评测时会预先去除。
